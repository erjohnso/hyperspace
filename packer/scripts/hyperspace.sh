...
sudo cp /srv/hyperspace/hyperspace/etc/nginx.conf /etc/nginx/sites-enabled/default
sudo ln -s /srv/hyperspace/hyperspace/etc/hyperspace.service /etc/systemd/system/
